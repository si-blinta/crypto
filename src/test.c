...
void proof_collision()
{
    ...
    printf("H1 :\n");
    print_hash(h1, HASH_SIZE, ANSI_COLOR_YELLOW "1f " ANSI_COLOR_RESET "04 " ANSI_COLOR_YELLOW "1c " ANSI_COLOR_RESET "15 2c 25 10 1f 14 18" ANSI_COLOR_MAGENTA);
    printf(ANSI_COLOR_RESET "\nH2 :\n");
    print_hash(h2, HASH_SIZE, ANSI_COLOR_YELLOW "3f " ANSI_COLOR_RESET "04 " ANSI_COLOR_YELLOW "3c " ANSI_COLOR_RESET "15 2c 25 10 1f 14 18" ANSI_COLOR_MAGENTA);
    printf(ANSI_COLOR_MAGENTA "\n################## TEST FINISHED ################\n");
}
#endif
